    ...
    <div className="grid gap-3">
      ...
      {focus === "custom" && (
        <input
          ...
          className="rounded-xl border-0 bg-gray-100 px-3 py-2.5 text-sm placeholder-gray-400 focus:ring-2 focus:ring-brand-500"
        />
      )}
      ...
      {result && (
        <div className="space-y-2">
          ...
          <div className="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm">
            ...
            <span className="text-gray-500"> · ~{result.totalDurationMinutes} min</span>
          </div>
              ...
              <div key={i} className="rounded-xl bg-white p-3 space-y-2">
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    ...
                    {ex.notes && <div className="mt-1 text-xs text-gray-400">{ex.notes}</div>}
                  </div>
                  <button
